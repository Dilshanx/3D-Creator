...
//         }"`
//       : selectedShape.type === "importedGLB" // Check for importedGLB
//       ? selectedShape.name || "Imported Model" // Use its name
//       : selectedShape.name || // Use name if available (like for custom extruded or renamed primitives)
//         selectedShape.type?.charAt(0).toUpperCase() +
//           selectedShape.type?.slice(1) // Fallback to capitalized type
//     : "None";
...
//       className='flex justify-between items-center px-6 py-3 bg-card/80 backdrop-blur-lg border-t border-border/60 text-xs shadow- ऊपर-md' // Note: "shadow- ऊपर-md" might be a typo or custom class
//     >
