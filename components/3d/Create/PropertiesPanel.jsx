...
//     { name: "Pyramid", type: "pyramid", icon: "🔺" },
//     { name: "3D Text", type: "text", icon: "📝" },
//     { name: "Image Plane", type: "imagePlane", icon: "🖼️" }, // New
//   ];
//   const popularShapeIcons = {
//     heart: "❤️",
//     star: "⭐",
...
//   const isImportedGLB = currentShapeType === "importedGLB";
//   const isText = currentShapeType === "text";
//   const isImagePlane = currentShapeType === "imagePlane"; // New check
...
//             else if (selectedShape.type === "importedGLB") yOffset = 0;
...
//               <>
//                 {" "}
//                 {/* Text specific: Add your text settings card here later */}
//                 {/* Placeholder for text settings card */}
//                 {/* <Card className='bg-background/50'>...</Card> */}
//               </>
//             )}
//             {isCustomExtruded && (
//               <>
//                 {" "}
//                 {/* Custom Extruded specific: Add your custom extruded settings card here later */}
//                 {/* Placeholder for custom extruded settings card */}
//                 {/* <Card className='bg-background/50'>...</Card> */}
//               </>
//             )}
...
//             {/* Appearance Section (hidden for ImagePlane and ImportedGLB) */}
...
//             {/* Animation Section (potentially disable for ImagePlane or simplify) */}
//             {!isImagePlane && ( // Example: Disabling animation controls for image planes
//               <Card className='bg-background/50'>
//                 <CardHeader>
//                   <CardTitle className='text-base'>Animation</CardTitle>
//                 </CardHeader>
...
//                 ❤️ Add Heart
//               </Button>
//               {/* Consider adding "Import Image Plane" button here */}
//             </div>
//           </motion.div>
//         )}
//       </AnimatePresence>
        ...
        centerObject: () => {
          ...
          if (selectedShape.scale && selectedShape.scale[1]) {
            if (selectedShape.type === "pyramid") yOffset = 0; // Base is at 0
              ...
              yOffset =
                ((selectedShape.planeHeight || 1) * selectedShape.scale[1]) /
                2; // Center vertically
            else if (selectedShape.type === "importedGLB") {
              // Centering imported GLB is complex, depends on its internal origin
              // For now, just center its bounding box origin if we could get it.
