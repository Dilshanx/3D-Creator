              ...
              <CardContent className='space-y-4'>
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      handleAnimationUpdate("type", value)
                    }
                  >
                    <SelectTrigger className='mt-1'>
                      <SelectValue />
                  ...
                  <>
                    <div>
                      ...
                      <Slider
                        ...
                        onValueChange={([value]) =>
                          handleAnimationUpdate("speed", value)
                        }
                        min={0.05}
                        max={5}
                        step={0.05}
                    ...
                    {animation.type === "rotate" && (
                      <div>
                        ...
                        <Select
                          ...
                          onValueChange={(value) =>
                            handleAnimationUpdate("axis", value)
                          }
                        >
                          <SelectTrigger className='mt-1'>
                            <SelectValue />
                      ...
                      <>
                        <div>
                          ...
                          <Slider
                            ...
                            onValueChange={([value]) =>
                              handleAnimationUpdate("orbitRadius", value)
                            }
                            min={0.1}
                            max={20}
                            step={0.1}
                        ...
                        <div>
                          ...
                          <Select
                            ...
                            onValueChange={(value) =>
                              handleAnimationUpdate("orbitPlane", value)
                            }
                          >
                            <SelectTrigger className='mt-1'>
                              <SelectValue />
                            ...
                            {["X", "Y", "Z"].map((axisName, index) => (
                              <div key={axisName}>
                                ...
                                <Input
                                  ...
                                  type='number'
                                  value={
                                    animation.orbitCenter[index]?.toString() ??
                                    "0"
                                  }
                                  onChange={(e) =>
