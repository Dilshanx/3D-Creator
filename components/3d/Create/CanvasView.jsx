...
//   R3FCanvas = r3f.Canvas;
// } catch (error) {
//   console.warn("@react-three/fiber Canvas not available:", error);
// }
...
//     event.preventDefault();
//     event.stopPropagation();
//     if (onDropOnCanvas) onDropOnCanvas(event);
//   };
...
// import { Suspense } from "react"; // No longer needed directly here if MainScene handles Suspense
// import React, { Suspense } from "react"; // Keep React
// import { motion, AnimatePresence } from "framer-motion";
// import * as THREE from "three";
...
//     event.stopPropagation();
//     if (onDropOnCanvas) {
//       onDropOnCanvas(event); // This now handles GLB and Images via Model3DCreator
//     }
//   };
...
//           toneMapping: THREE.ACESFilmicToneMapping,
//           outputColorSpace: THREE.SRGBColorSpace,
//           preserveDrawingBuffer: true, // Set to true for reliable screenshots
//         }}
//         onCreated={({ gl, scene }) => {
//           if (THREE) {
//             gl.shadowMap.enabled = true;
...
// components/3d/Create/CanvasView.jsx
